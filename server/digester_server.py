...
from common import digestor_pb2
from common import digestor_pb2_grpc
...
class DigestorServicer(digestor_pb2_grpc.DigestorServicer):
	...
	def start_server(self):
		...
		digestor_pb2_grpc.add_DigestorRestServicer_to_server(DigestorServicer(), digestor_server)
